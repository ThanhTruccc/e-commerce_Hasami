 ...
 * Displays detailed information of an order for admin users, including
 * user information, order items, shipping details, payment status, and a
 * form to update the order status.
 */
?>
<!-- app/views/admin/order_detail.php -->
<?php $pageTitle = 'Chi Tiết Đơn Hàng (Admin) | GlowViet Admin'; ?>
<section class="order-detail-section py-5 bg-light">
    <div class="container">
        <div class="d-flex align-items-center mb-4">
            <a href="<?= APP_URL ?>/admin/orders" class="btn btn-outline-secondary btn-sm me-3">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded-4 mb-4">
                    <div class="card-body p-4">
                        ...
                        <form action="<?= APP_URL ?>admin/orderStatus/<?= $order['id'] ?>" method="POST" class="d-flex align-items-center mb-3">
                            <label class="me-2 mb-0">Cập nhật trạng thái:</label>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="product-img-mini">
                                                    <?php if ($item['image']): ?>
                                                    <img src="<?= APP_URL ?>/images/products/<?= htmlspecialchars($item['image']) ?>" alt="" class="rounded" style="width: 50px; height: 50px; object-fit: cover;">
                                                    <?php endif; ?>
                                                </div>
                                                <div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="fw-600"><?= $order['payment_method'] === 'online' ? 'Thanh toán Online (VNPay)' : 'Thanh toán khi nhận hàng (COD)' ?></span>
                        </div>
                        <div class="mb-3">
                            ...
                            $ps = $payMap[$order['payment_status']] ?? ['bg-secondary', $order['payment_status']];
                            ?>
                ...
                <div class="card shadow-sm border-0 rounded-4 mt-4">
                    <div class="card-body p-4">
                        <h5 class="fw-700 mb-3"><i class="bi bi-person me-2"></i>Thông Tin Khách Hàng</h5>
                        <div class="mb-2">
                            <span class="text-muted small d-block">Tên</span>
                            <span class="fw-600"><?= htmlspecialchars($user['name']) ?></span>
                        </div>
                        <div class="mb-2">
                            <span class="text-muted small d-block">Email</span>
                            <span class="fw-600"><?= htmlspecialchars($user['email']) ?></span>
                        </div>
                        <div class="mb-2">
                            <span class="text-muted small d-block">Số điện thoại</span>
                        ...
                        <div class="mb-2">
                            <span class="text-muted small d-block">Loại da</span>
                            <span class="fw-600"><?= htmlspecialchars($user['skin_type'] ?? '') ?></span>
                        </div>
                    </div>
                </div>
            </div>
